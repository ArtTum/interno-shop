...
namespace App\Repositories\MarketplaceSetting;
...
class MarketplaceSettingRepository extends BaseRepository
{
   public function __construct(MarketplaceSetting $model)
    {
        $this->model = $model;
    }
