...
namespace App\Repositories\NewsletterBlacklist;
...
class NewsletterBlacklistRepository extends BaseRepository
{
   public function __construct(NewsletterBlacklist $model)
    {
        $this->model = $model;
    }
