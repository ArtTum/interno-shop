...
namespace App\Repositories\UserShippingAddress;

use App\Models\UserBillingAddress;
use App\Models\UserShippingAddress;
use App\Repositories\BaseRepository;
use App\Repositories\UserShippingAddress\Interfaces\UserShippingAddressRepositoryInterface;
use Illuminate\Database\Eloquent\Builder;
use Illuminate\Database\Eloquent\Collection;
use Illuminate\Database\Eloquent\Model;
use Illuminate\Support\Facades\DB;

class UserShippingAddressRepository extends BaseRepository implements UserShippingAddressRepositoryInterface
{
    public function __construct(UserShippingAddress $model)
    {
        $this->model = $model;
    }
