...
return [
    ...
    'menuGroups' => [
        [
            ...
            'children' => [
                'hy' => ['Profile', 'Mesh', 'Wood material', 'Tube'],
        ...
        [
            ...
            'children' => [
                'hy' => ['LED strip', 'Lamps', 'Accessories'],
    ...
    'products' => array_map(function ($product) {
        return array_merge([
            'options' => ['code' => '111', 'size' => 'Profile', 'quantity' => '1', 'type' => 'Type', 'unit' => '111', 'piece' => '44', 'height' => '111', 'material' => 'Material name', 'color' => '#1f1f1f'],
        ], $product);
    }, [
        ['id' => 1, 'title' => ['hy' => 'Aluminum profile with a refined black finish', 'en' => 'Aluminum profile with a refined black finish', 'ru' => 'Алюминиевый профиль с черным покрытием'], 'price' => '15000', 'kind' => 'black', 'image' => '/assets/products/profile-black.png', 'isNew' => true],
        ['id' => 2, 'title' => ['hy' => 'Silver profile for stretch ceiling systems', 'en' => 'Silver profile for stretch ceiling systems', 'ru' => 'Серебристый профиль для натяжных потолков'], 'price' => '15000', 'kind' => 'silver', 'image' => '/assets/products/profile-silver.png', 'isNew' => true],
        ['id' => 3, 'title' => ['hy' => 'Black corner profile for precise installation', 'en' => 'Black corner profile for precise installation', 'ru' => 'Черный угловой профиль для точного монтажа'], 'price' => '15000', 'kind' => 'black', 'image' => '/assets/products/profile-black.png', 'isNew' => true],
        ['id' => 4, 'title' => ['hy' => 'Durable silver profile for light lines', 'en' => 'Durable silver profile for light lines', 'ru' => 'Прочный серебристый профиль для световых линий'], 'price' => '15000', 'kind' => 'silver', 'image' => '/assets/products/profile-silver.png', 'isNew' => true],
        ['id' => 5, 'title' => ['hy' => 'Wood-look panel for wall and ceiling finishes', 'en' => 'Wood-look panel for wall and ceiling finishes', 'ru' => 'Панель под дерево для стен и потолков'], 'price' => '15000', 'kind' => 'wood', 'image' => '/assets/products/panel-wood.png', 'isNew' => true],
        ['id' => 6, 'title' => ['hy' => 'Black profile for minimal interior solutions', 'en' => 'Black profile for minimal interior solutions', 'ru' => 'Черный профиль для минималистичных интерьеров'], 'price' => '15000', 'kind' => 'black', 'image' => '/assets/products/profile-black.png', 'isNew' => true],
        ['id' => 7, 'title' => ['hy' => 'Silver mounting profile for fast installation', 'en' => 'Silver mounting profile for fast installation', 'ru' => 'Серебристый монтажный профиль для быстрой установки'], 'price' => '15000', 'kind' => 'silver', 'image' => '/assets/products/profile-silver.png', 'isNew' => true],
        ['id' => 8, 'title' => ['hy' => 'Black profile for concealed mounting systems', 'en' => 'Black profile for concealed mounting systems', 'ru' => 'Черный профиль для скрытых систем крепления'], 'price' => '15000', 'kind' => 'black', 'image' => '/assets/products/profile-black.png', 'isNew' => true],
        ['id' => 9, 'title' => ['hy' => 'Silver profile with LED lighting channel', 'en' => 'Silver profile with LED lighting channel', 'ru' => 'Серебристый профиль с каналом для LED'], 'price' => '15000', 'kind' => 'silver', 'image' => '/assets/products/profile-silver.png', 'isNew' => true],
        ['id' => 10, 'title' => ['hy' => 'Warm-tone decorative wood-look panel', 'en' => 'Warm-tone decorative wood-look panel', 'ru' => 'Декоративная панель под дерево теплого оттенка'], 'price' => '15000', 'kind' => 'wood', 'image' => '/assets/products/panel-wood.png', 'isNew' => true],
    ]),
    'settings' => [
    ...
    'privacy' => [
        ...
        'content' => [
            'hy' => [
                'kicker' => 'Privacy Policy', 'title' => 'The safe use of your data is important to us', 'intro' => 'This page explains what data we may collect, how we use it, and what rights you have.', 'badgeTitle' => 'Secure orders', 'badgeText' => 'Order data is processed only for service purposes', 'summaryLabel' => 'Short summary', 'summaryTitle' => 'We use only necessary data', 'summaryText' => 'Data is used to process orders, contact customers, and improve service quality.', 'checklist' => ['We do not sell data', 'We keep data only as needed', 'Contact details are used only for orders'], 'updated' => 'Last updated', 'summaryAria' => 'Short summary', 'checklistAria' => 'Main principles',
                'sections' => [
                    ...
                    ['index' => '02', 'icon' => '↗', 'title' => 'How we use data', 'text' => 'Data is used to confirm the order, check product availability, arrange delivery, and contact you when needed.'],
                    ...
                    ['index' => '04', 'icon' => '⌁', 'title' => 'Storage and security', 'text' => 'Data is kept as long as needed for order service and record keeping. We use reasonable measures to protect it.'],
                    ['index' => '05', 'icon' => '?', 'title' => 'Your rights', 'text' => 'You can contact us to request correction, update, or deletion of your data. For questions, you can write or call us.'],
                ],
            ],
            'en' => [
