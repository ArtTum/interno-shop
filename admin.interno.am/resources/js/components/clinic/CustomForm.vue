        ...
        <div class="grid grid-cols-2 gap-9">
            <div class="flex flex-col p-6.5">
                <CustomInput
                    ...
                    label="Կլինիկա *"
                    type="text"
                    placeholder="Մուտքագրեք կլինիկայի անունը"
                    @keyup="form.errors = validate(form)"
                    :error="form.errors['clinic']"
                />
            </div>
            <div class="flex flex-col p-6.5">
                <CustomInput
        ...
        <div class="grid grid-cols-2 gap-9">
            ...
            <div class="flex flex-col p-6.5">
                <CustomInput
                    ...
                    label="Այլ զեղչ"
                    type="text"
                    placeholder="Մուտքագրեք այլ զեղչ"
                    @keyup="form.errors = validate(form)"
                    :error="form.errors['other_sale']"
                />
            </div>
        </div>
        <div class="grid grid-cols-2 gap-9">
        ...
        <div class="grid grid-cols-1 gap-9">
            <div class="flex flex-col p-6.5 save-button-fixed">
                <div class="flex ml-auto gap-5">
                        <CustomButton
                            v-if="form.id && (auth?.superadmin || auth?.user_group?.permissions_by_name.clinics[0].can_delete)"
