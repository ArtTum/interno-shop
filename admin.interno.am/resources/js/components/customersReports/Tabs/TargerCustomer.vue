...
import {ref} from "vue";
import ChartTabsTargerCustomer from "@components/customersReports/ChartTabsTargerCustomer.vue";
...
const currentComparingTabValues = [
    ...
    'total_discount_price_series', 'total_refund_amount_series'
];
...
<template>
    <div class="mt-4" v-if="params.user_id > -1 && pageData.data?.chartDataLabels && pageData.data?.chartDataSeries?.[currentComparingTabValues[currentComparingTabIndex]]">
        <ChartTabsTargerCustomer
                ...
                <template #header>
                    <div>
                        <div class="relative">
                            ...
                            >
                                <button
                                    @click="emits('export-datatable', `ID-${params.user_id}-user`), dataTableDropDown = false"
                                    type="button"
