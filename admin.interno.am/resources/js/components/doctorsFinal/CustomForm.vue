        ...
        <div class="grid grid-cols-2 gap-9">
            <div class="flex flex-col p-6.5">
                <CustomInput
                    ...
                    type="text"
                    placeholder="Մուտքագրեք անունը և ազգանունը"
            ...
            <div class="flex flex-col p-6.5">
                <CustomInput
                    ...
                    type="text"
                    placeholder="Մուտքագրեք մասնագիտությունը"
                    @keyup="form.errors = validate(form)"
        ...
        <div class="grid grid-cols-2 gap-9">
            <div class="flex flex-col p-6.5">
                <CustomInput
                    ...
                    label="Աստիճան"
                    type="text"
                    placeholder="Մուտքագրեք աստիճանը"
                    @keyup="form.errors = validate(form)"
            ...
            <div class="flex flex-col p-6.5">
                <CustomInput
                    ...
                    label="Աշխատավայր"
                    type="text"
                    placeholder="Մուտքագրեք աշխատավայրը"
                    @keyup="form.errors = validate(form)"
        ...
        <div class="grid grid-cols-1 gap-9">
            <div class="flex flex-col p-6.5">
                <CustomInput
                    ...
                    name="other_info"
                    label="Այլ տեղեկություններ"
                    type="text"
                    placeholder="Մուտքագրեք այլ տեղեկություններ"
                    @keyup="form.errors = validate(form)"
                    :error="form.errors['other_info']"
                />
            </div>
        </div>
        <div class="grid grid-cols-1 gap-9">
            <div class="flex flex-col p-6.5 save-button-fixed">
                <div class="flex ml-auto gap-5">
                        <CustomButton
                            v-if="form.id && (auth?.superadmin || auth?.user_group?.permissions_by_name.doctors_finals[0].can_delete)"
