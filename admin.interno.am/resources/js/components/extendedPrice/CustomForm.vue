        ...
        <div class="grid grid-cols-2 gap-9">
            ...
            <div class="flex flex-col p-6.5">
                <CustomInput
                    ...
                    label="Կլինիկա"
                    type="text"
                    placeholder="Մուտքագրեք կլինիկան"
                    @keyup="form.errors = validate(form)"
        ...
        <div class="grid grid-cols-3 gap-9">
            ...
            <div class="flex flex-col p-6.5">
                <CustomInput
                    ...
                    label="Զեղչված գին"
                    type="text"
                    placeholder="Մուտքագրեք զեղչված գինը"
                    @keyup="form.errors = validate(form)"
        ...
        <div class="grid grid-cols-1 gap-9">
            <div class="flex flex-col p-6.5 save-button-fixed">
                <div class="flex ml-auto gap-5">
                        <CustomButton
                            v-if="form.id && (auth?.superadmin || auth?.user_group?.permissions_by_name.extended_prices[0].can_delete)"
