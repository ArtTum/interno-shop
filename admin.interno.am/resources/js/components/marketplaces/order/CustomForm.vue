...
import GeneralTab from "@components/marketplaces/order/GeneralTab.vue";
import CustomerInfoTab from "@components/marketplaces/order/CustomerInfoTab.vue";
import OrderItemsTab from "@components/marketplaces/order/OrderItemsTab.vue";
import OrderNotesTab from "@components/marketplaces/order/OrderNotesTab.vue";
import OrderDocumentsTab from "@components/marketplaces/order/OrderDocumentsTab.vue";

import {computed, ref, toRefs, watch} from "vue";
import {useStore} from "vuex";
import ShippingLabelsTab from "@components/marketplaces/order/ShippingLabelsTab.vue";
                    ...
                    <template #content>
                        ...
                        >
                            ...
                            >
                                ...
                                <div class="col-span-1 items-center justify-center sm:flex">
                                    <CustomInput
                                        name="select"
                                        type="checkbox"
                                        @change="(value) => {
        ...
        <form @submit.prevent="emits('submit'), justSubmitted = true">
            ...
            <div class="grid grid-cols-1 gap-9">
                ...
                <span
                    ...
                    :class="{'bg-warning text-warning': form.status_old >= 1 && form.status_old <= 3 ,
                                      'bg-danger text-danger': form.status_old >= 5 && form.status_old <= 8,
                                      'bg-success text-success': form.status_old === 4
                                    }"
                >
                   {{ params?.orderStatuses?.[form.status_old] }}
            </span>
                </div>
            </div>
            <div class="grid grid-cols-1 gap-9 ">
                    ...
                    <div class="flex ml-auto gap-5" v-if="!getRefundPrice">
                        <template
                            ...
                            <CustomButton
                                ...
                                class="rounded bg-meta-3 py-2 px-4.5 font-medium text-white hover:bg-opacity-80 whitespace-nowrap"
                                type="button"
                            >
                                <font-awesome-icon :icon="['fas', 'repeat']" class="mr-1"/>
