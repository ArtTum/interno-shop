...
<template>
    <div v-if="isOpen"
        ...
        <!-- Modal Box -->
        <div class="bg-white rounded-lg shadow-lg max-w-[800px] w-full">
            <!-- Modal Header -->
            <div class="flex justify-between items-center px-4 border-b">
                <div class="grid grid-cols-12 gap-4 w-full">
                    <div class="col-span-11 p-4">
                        <h3 class="text-lg font-semibold">{{ title }}</h3>
                    </div>
                    <div class="col-span-1 p-4 flex">
            ...
            <div class="p-6 max-h-[80vh] min-h-[60vh] overflow-y-auto">
                <slot/>
            </div>
