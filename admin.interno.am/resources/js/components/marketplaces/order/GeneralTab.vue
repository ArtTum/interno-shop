...
<template>
    <div>
        ...
        <template v-if="form.is_dangerous">
            <div
                class="inline-flex rounded-full bg-opacity-10 py-2 px-5 text-sm font-medium bg-danger text-danger items-center">
                <font-awesome-icon :icon="['far', 'skull-crossbones']" class="mr-2"/>
        ...
        <template v-if="form.reshipments?.length">
            <div class="text-danger">
                <font-awesome-icon :icon="['fas', 'repeat']" class="mr-2"/>
                <span>This order has reshipment order<template v-if="form.reshipments.length > 1">s</template>:
        ...
        <div class="flex items-center">
            ...
            <span class="text-base text-black-2 ml-2">{{ form.same_day_delivery ? 'Yes!!!' : 'No' }}</span>
        </div>
        <hr class="text-gray my-3">
        <div class="flex items-center">
            <font-awesome-icon :icon="['fasr', 'file']"/>
            <span class="text-base ml-1">Processed by tax exporter:</span>
            <span class="text-base text-black-2 ml-2">{{ form.exported_taxfile ? 'Yes!!!' : 'No' }}</span>
        </div>
        <hr class="text-gray my-3">
        <div class="flex items-center">
            <font-awesome-icon :icon="['fasr', 'circle-exclamation']"/>
        ...
        <div class="flex items-center">
            ...
            <template v-if="form.status_old === 3">
                <CustomSelect
                    ...
                    :searchable="false"
                    :canClear="false"
                    class="py-0 ml-3 rounded-lg border-stroke bg-transparent w-[200px]"
                />
            </template>
        ...
        <template v-if="form.coupon_code">
            ...
            <div>
                ...
                <template v-if="form.coupon_id && auth.user_group.permissions_by_name.coupons[0].can_view">
                    <a
                        class="ml-2"
        ...
        <template v-if="form.shared_cart_user_id">
            ...
            <div>
                ...
                <span class="text-base ml-1">By shared cart (ID and created by): </span>
                    <span class="text-base text-black-2">#{{ form.shared_cart_id }} | {{ form.shared_cart_user_name }}</span>
            </div>
        </template>
        <template v-if="form.offer_user_id">
            ...
            <div>
                ...
                <span class="text-base ml-1">By offer (ID and created by): </span>
                    <span class="text-base text-black-2">#{{ form.offer_id }} | {{ form.offer_user_name }}</span>
            </div>
        </template>
        <hr class="text-gray my-3">
        <div>
        ...
        <template v-if="parseFloat(form.shipping_cost)">
            ...
            <div>
                ...
                <span class="text-base ml-1">Shipping cost:</span>
                <span class="text-base text-black-2 ml-2">
        ...
        <template v-if="parseFloat(form.shipping_price)">
            <div>
                <span class="text-base ml-1">- Shipping price:</span>
                <span class="text-xs text-black-2 ml-2 font-bold">
        ...
        <template v-if="parseFloat(form.shipping_subtotal_tax)">
            <div>
                <span class="text-base ml-1">- Shipping subtotal tax amount:</span>
                <span class="text-xs text-black-2 ml-2 font-bold">
        ...
        <template v-if="parseFloat(form.total_tax)">
            <div>
                <span class="text-base ml-1">- Total tax amount:</span>
                <span class="text-xs text-black-2 ml-2 font-bold">
