...
const productsPopup = ref(false)
const productsIndexShowing = ref(null)
...
<template>
    ...
    <template v-if="productsPopup" >
        <PopupWithSlot
            classes="max-w-[80%] w-[80%]"
            @close="productsPopup = false, productsIndexShowing = null"
        >
            <CustomTableSecond
                title="Messages"
            >
            ...
            <div class="flex flex-col">
                ...
                <template v-else>
                    <div class="flex">
                        ...
                        <div class="ml-auto flex" v-if="!refundInfo.fulled_tax && !refundInfo.fulled">
                            <CustomInput
                                @input="setRefundPercentAndAmount('amount', refundInAmount)"
                                :disabled="!!refundInPercent"
                                v-model="refundInAmount"
                                class="w-fit justify-center items-center ml-auto mr-5 gap-3"
                                :table-input="true"
                                name="refundInAmount"
                            ...
                            <CustomInput
                                ...
                                class="w-fit justify-center items-center gap-3"
                                :table-input="true"
        ...
        <template #content>
            <template v-if="newItem">
                <div class="grid grid-cols-9 border-t border-stroke py-4.5 px-4 md:px-6 2xl:px-7.5">
                    <div class="col-span-6 hidden sm:flex flex-col mr-5">
                        <CustomSelect
                    ...
                    <div class="col-span-1 sm:flex flex-col mr-5">
                        <CustomInput
                            :table-input="true"
            ...
            >
                ...
                >
                    ...
                    <div class="col-span-2 hidden sm:flex flex-col">
                    ...
                    <div class="col-span-1 hidden items-center sm:flex mr-3">
                    ...
                    <div class="col-span-1 flex items-center">
                        ...
                        <template v-if="item.product_id && auth.user_group.permissions_by_name.products[0].can_view">
                            <a
                                class="ml-2"
                        ...
                        >
                            <font-awesome-icon
                                @click="productsIndexShowing = index, productsPopup = true"
                                class="text-black hover:text-primary"
                                :icon="['fas', 'envelope']"
                            />
                        </button>
            ...
            <div
                ...
                <div class="col-span-2 flex flex-col">
                    <div>
                        <span class="text-base ml-1">- Items subtotal:</span>
                    ...
                    <template v-if="parseFloat(form.items_subtotal_tax)">
                        <div>
                            <span class="text-base ml-1">- Items subtotal tax amount:</span>
                            <span class="text-xs text-black-2 ml-2 font-bold">
    ...
    >
        <template #content>
            <div
                class="grid grid-cols-8 border-t border-stroke py-4.5 px-4 md:px-6 2xl:px-7.5"
            >
                <div class="col-span-2 hidden items-center sm:flex">
                    <p class="font-medium">Name</p>
                </div>
            ...
            <div
                class="grid grid-cols-10 border-t border-stroke py-4.5 px-4 md:px-6 2xl:px-7.5">
                <div class="col-span-2 flex items-center">
                </div>
                <div class="col-span-2 hidden sm:flex flex-col">
                </div>
                ...
                <div class="col-span-2 flex flex-col">
                    <template v-if="parseFloat(form.zip_fee)">
                        <div>
                            <span class="text-base ml-1">- {{ form.zip_fee_label }}:</span>
                            <span class="text-xs text-black-2 ml-2 font-bold">
                    ...
                    <template v-if="parseFloat(form.zip_fee_tax)">
                        <div>
                            <span class="text-base ml-1">- {{ form.zip_fee_label }} tax:</span>
                            <span class="text-xs text-black-2 ml-2 font-bold">
                    ...
                    <template v-if="parseFloat(form.total_discount_price)">
                        <div>
                            <span class="text-base ml-1">- Discounted amount:</span>
                            <span class="text-xs text-black-2 ml-2 font-bold">
                    ...
                    <div class="font-bold">
                        <span class="text-base ml-1">Total amount:</span>
                    ...
                    <template v-if="form.order_refund">
                        <div class="font-bold">
                            <span class="text-base ml-1">Net Payment:</span>
                            <span class="text-base text-black-2 ml-2">
                                {{
                    ...
                    <template v-if="refundInfo">
                        <div class="font-bold">
                            <span class="text-base ml-1">Refund amount:</span>
                            <span class="text-base text-black-2 ml-2">
                    ...
                    <template v-if="!form.payment_date && form.status_old === 3 && !form.coupon_code">
                        <div class="grid grid-cols-4">
                            <div class="flex flex-col p-6.5 pr-0 pb-3 col-span-3">
                                <CustomInput
                                    class="w-full"
                            ...
                            <div class="flex w-full py-6.5 pb-0 col-span-1">
                                <CustomButton
                                    :disabled="!applayingCoupon.coupon_code"
                                    @click="applyCoupon"
                                    type="button"
                                    class="flex h-fit items-center gap-2 rounded-tr rounded-br bg-primary mt-auto mb-auto py-3 px-4.5 font-medium text-white hover:bg-opacity-80"
                                >
                                    <div>
                    ...
                    <template v-if="(!form.order_refund || !form.order_refund.fulled) && refundInfo">
                        <div class="grid grid-cols-4">
                            <div class="flex flex-col p-6.5 pt-0 pr-0 pb-3 col-span-4">
                                <CustomSelect
                                    class="py-0 rounded-lg border-stroke bg-transparent"
                                    :searchable="true"
