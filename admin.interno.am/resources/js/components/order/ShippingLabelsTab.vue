...
<template>
    <div class="flex flex-wrap justify-between gap-4 mb-2">
        <h1 class="text-xl font-bold text-black">Shipping labels</h1>
        <div class="flex flex-wrap gap-2">
            <a
                target="_blank"
                :href="getShippingLabel(4).nf4_file + '?v=' + Date.now()"
                v-if="getShippingLabel(4) && getShippingLabel(4).nf4_file"
                class="text-center   gap-2 rounded bg-primary py-2 px-2 font-medium text-white hover:bg-opacity-80 w-fit"
                type="button"
            >
    ...
    <div class="grid grid-cols-4 gap-4 max-2xl:grid-cols-2 max-md:grid-cols-1">
        <div v-if="filteredItem(1)" class="rounded-sm border border-stroke bg-white shadow-default ">
            ...
            <div class="p-4" v-if="getShippingLabel(1)">
                ...
                <div class="flex gap-2 mt-5">
                    <a
                        ...
                        class="text-center  gap-2 rounded bg-primary py-2 px-2 font-medium text-white hover:bg-opacity-80 w-full"
                        type="button"
                    >
                        <font-awesome-icon :icon="['far', 'download']"/>
                        Download
                    ...
                    <CustomButton
                        ...
                        class=" text-center  gap-2 rounded border-meta-1 bg-meta-1 py-2 px-2 font-medium text-white hover:bg-opacity-80 w-full"
                        type="button"
                    >
                ...
                <div>
                    ...
                    <custom-button
                        ...
                        type="button"
                        class="gap-2 rounded bg-meta-3 py-2 px-4.5 mt-3 font-medium text-white hover:bg-opacity-80 w-full">
            ...
            <div class="p-4" v-else>
                ...
                <Switch
                    ...
                    class="w-fit mb-3 shipping-label-switch"
                ...
                />
                <custom-button
                    :disabled="order.number || checkShippingLabel([2,4], order.alternative_shipping)"
                    type="button"
                    @click="createShippingLabel(1)"
                    class="gap-2 rounded bg-meta-3  py-2 mt-3 px-4.5 font-medium text-white hover:bg-opacity-80 w-full">
                    <font-awesome-icon :icon="['fas', 'plus']"/>
        ...
        <div v-if="filteredItem(2)" class="rounded-sm border border-stroke bg-white shadow-default ">
            ...
            <div class="p-4" v-else>
                ...
                />
                <custom-button
                    :disabled="order.number || checkShippingLabel([1,4], order.alternative_shipping)"
                    type="button"
        ...
        <div v-if="filteredItem(4)" class="rounded-sm border border-stroke bg-white shadow-default ">
                    ...
                    <template v-if="getShippingLabel(4).adb_file_path">
                        <div class="flex flex-col gap-2 mt-5">
                            <a
                                ...
                                class="block w-full text-center rounded bg-primary py-2 px-2 font-medium text-white hover:bg-opacity-80"
                                type="button"
                            >
                                <font-awesome-icon :icon="['far', 'download']"/>
            ...
            <div class="p-4" v-else>
                ...
                <custom-button
                    ...
                    class="gap-2 rounded bg-meta-3 mt-3 py-2 px-4.5 font-medium text-white hover:bg-opacity-80 w-full">
                    <font-awesome-icon :icon="['fas', 'plus']"/>
                    Create shipping label
                </custom-button>
            </div>
    ...
    >
        <div class="grid grid-cols-4 gap-4 max-xl:grid-cols-1">
            <div class="col-span-3 px-4">
                <div class="overflow-x-auto max-md:mb-4">
                    <div class="max-md:w-[1000px]">
                ...
                <CustomButton
                    ...
                    @click="addNewSection"
                    type="button"
                    class="flex items-center gap-2 rounded bg-meta-3 py-2 px-2.5 font-medium text-white hover:bg-opacity-80 ml-auto"
                >
