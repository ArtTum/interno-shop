                    ...
                    <template v-if="element.open">
                        <div class="grid grid-cols-3 gap-9 text-left mt-5 px-6.5">
                            <div class="flex flex-col gap-9">
                                <CustomMediaList
                                    @remove-images="this.$emit('removeImage', index)"
                                    label="Icon *"
                                    @insert="(data) => {
                                        this.$emit('insertImage', data, index)
                                    }"
                            ...
                            <div class="gap-9">
                                ...
                                <CKEditorComponent
                                    :model="element.popup_text"
                                    @updateValue="(value) => {
                                        element.popup_text = value
                                    }"
                                />
                            </div>
                        </div>
...
export default {
    name: "usp-list-component-fields-drag-and-drop",
    methods: {
        emitter(value) {
