...
<template>
    <form @submit.prevent="emits('submit')">
        ...
        <div
            v-if="Object.keys(form.exists).length > 0 && form.exists.general"
            class="grid grid-cols-1 gap-9 p-6.5"
        >
            <AlertError :errors="form.exists.general"/>
        </div>
        <div class="grid grid-cols-12 gap-9">
            ...
            <div class="col-span-9 flex flex-col p-6.5">
                <CustomTextarea
                    ...
                    label="TNT Consignment Note Numbers *"
                    name="text"
                    v-model="form.text"
            ...
            <div class="col-span-3 flex flex-col p-6.5">
                <div class="flex ml-auto gap-5 mt-auto">
