...
const actions = {
    async fetchPageData({commit}, params) {
        const res = await baseHttp.get('clinics/fetch', {
            params
        });
    ...
    async fetchByField({commit}, params) {
        const res = await baseHttp.get('clinics/fetch-by-field', {
            params
        });
    ...
    async delete({state}) {
        return await baseHttp.delete(`clinics/delete/${state.deletingItemId}`);
    },

    async create({}, params) {
        return await baseHttp.post(`clinics/insert`, params);
    },

    async update({}, params) {
        return await baseHttp.put(`clinics/update`, params);
    },
};
