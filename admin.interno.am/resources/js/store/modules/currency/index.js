...
const actions = {
    async fetchPageData({commit}, params) {
        const res = await baseHttp.get('currencies/fetch', {
            params
        });
    ...
    async fetchByField({commit}, params) {
        const res = await baseHttp.get('currencies/fetch-by-field', {
            params
        });
    ...
    async delete({state}) {
        return await baseHttp.delete(`currencies/delete/${state.deletingItemId}`);
    },

    async create({}, params) {
        return await baseHttp.post(`currencies/insert`, params);
    },

    async update({}, params) {
        return await baseHttp.put(`currencies/update`, params);
    },
};
