...
const actions = {
    async fetchPageData({commit}, params) {
        const res = await baseHttp.get('customer-groups/fetch', {
            params
        });
    ...
    async fetchByField({commit}, params) {
        const res = await baseHttp.get('customer-groups/fetch-by-field', {
            params
        });
    ...
    async delete({state}) {
        return await baseHttp.delete(`customer-groups/delete/${state.deletingItemId}`);
    },

    async create({}, params) {
        return await baseHttp.post(`customer-groups/insert`, params);
    },

    async update({}, params) {
        return await baseHttp.put(`customer-groups/update`, params);
    },
};
