...
const actions = {
    async fetchPageData({commit}, params) {
        const res = await baseHttp.get('diseases/fetch', {
            params
        });
    ...
    async fetchByField({commit}, params) {
        const res = await baseHttp.get('diseases/fetch-by-field', {
            params
        });
    ...
    async delete({state}) {
        return await baseHttp.delete(`diseases/delete/${state.deletingItemId}`);
    },

    async create({}, params) {
        return await baseHttp.post(`diseases/insert`, params);
    },

    async update({}, params) {
        return await baseHttp.put(`diseases/update`, params);
    },
};
