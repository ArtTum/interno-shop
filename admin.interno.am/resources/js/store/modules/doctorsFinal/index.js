...
const actions = {
    async fetchPageData({commit}, params) {
        const res = await baseHttp.get('doctors-final/fetch', {
            params
        });
    ...
    async fetchByField({commit}, params) {
        const res = await baseHttp.get('doctors-final/fetch-by-field', {
            params
        });
    ...
    async delete({state}) {
        return await baseHttp.delete(`doctors-final/delete/${state.deletingItemId}`);
    },

    async create({}, params) {
        return await baseHttp.post(`doctors-final/insert`, params);
    },

    async update({}, params) {
        return await baseHttp.put(`doctors-final/update`, params);
    },
};
