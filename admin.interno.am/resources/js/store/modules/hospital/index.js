...
const actions = {
    async fetchPageData({commit}, params) {
        const res = await baseHttp.get('hospitals/fetch', {
            params
        });
    ...
    async fetchByField({commit}, params) {
        const res = await baseHttp.get('hospitals/fetch-by-field', {
            params
        });
    ...
    async delete({state}) {
        return await baseHttp.delete(`hospitals/delete/${state.deletingItemId}`);
    },

    async create({}, params) {
        return await baseHttp.post(`hospitals/insert`, params);
    },

    async update({}, params) {
        return await baseHttp.put(`hospitals/update`, params);
    },
};
