...
const actions = {
    async fetchPageData({commit}, params) {
        const res = await baseHttp.get('media-settings/fetch', {
            params
        });
    ...
    async fetchByField({commit}, params) {
        const res = await baseHttp.get('media-settings/fetch-by-field', {
            params
        });
    ...
    async update({}, params) {
        return await baseHttp.put(`media-settings/update`, params);
    },
};
