...
const actions = {
    async fetchPageData({commit}, params) {
        const res = await baseHttp.get('member-groups/fetch', {
            params
        });
    ...
    async fetchByField({commit}, params) {
        const res = await baseHttp.get('member-groups/fetch-by-field', {
            params
        });
    ...
    async delete({state}) {
        return await baseHttp.delete(`member-groups/delete/${state.deletingItemId}`);
    },

    async create({}, params) {
        return await baseHttp.post(`member-groups/insert`, params);
    },

    async update({}, params) {
        return await baseHttp.put(`member-groups/update`, params);
    },
};
