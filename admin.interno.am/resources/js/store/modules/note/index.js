...
const actions = {
    async fetchPageData({commit}, params) {
        const res = await baseHttp.get('notes/fetch', {
            params
        });
    ...
    async fetchByField({commit}, params) {
        const res = await baseHttp.get('notes/fetch-by-field', {
            params
        });
    ...
    async delete({state}) {
        return await baseHttp.delete(`notes/delete/${state.deletingItemId}`);
    },

    async create({}, params) {
        return await baseHttp.post(`notes/insert`, params);
    },

    async update({}, params) {
        return await baseHttp.put(`notes/update`, params);
    },
};
