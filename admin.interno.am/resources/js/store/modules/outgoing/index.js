...
const actions = {
    async fetchPageData({commit}, params) {
        const res = await baseHttp.get('outgoings/fetch', {
            params
        });
    ...
    async fetchIndexParams({commit}, params) {
        const res = await baseHttp.get('outgoings/fetch-index-params', {
            params: {
    ...
    async fetchByField({commit}, params) {
        const res = await baseHttp.get('outgoings/fetch-by-field', {
            params
        });
    ...
    async delete({state}) {
        return await baseHttp.delete(`outgoings/delete/${state.deletingItemId}`);
    },

    async create({}, params) {
        return await baseHttp.post(`outgoings/insert`, params);
    },

    async update({}, params) {
        return await baseHttp.put(`outgoings/update`, params);
    },
};
