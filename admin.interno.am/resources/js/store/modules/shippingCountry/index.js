...
const actions = {
    async fetchPageData({commit}, params) {
        const res = await baseHttp.get('shipping-countries/fetch', {
            params
        });
    ...
    async fetchByField({commit}, params) {
        const res = await baseHttp.get('shipping-countries/fetch-by-field', {
            params
        });
    ...
    async fetchParams({commit}, params) {
        const res = await baseHttp.get('shipping-countries/fetch-params', {params});
        commit('SET_PARAMS', res.data);
    },

    async delete({state}) {
        return await baseHttp.delete(`shipping-countries/delete/${state.deletingItemId}`);
    },

    async create({}, params) {
        return await baseHttp.post(`shipping-countries/store`, params);
    },

    async update({}, params) {
        return await baseHttp.put(`shipping-countries/update`, params);
    },
};
