...
const state = () => ({
    ...
    deletingItemId: null,
    pageData: {data: [], pagination: {}, languages: [], categories: [], categoryTree: [], kinds: [], optionTypes: [], optionColors: [], attributeValues: {}},
    params: {languages: [], categories: [], categoryTree: [], kinds: [], optionTypes: [], optionColors: [], attributeValues: {}},
    editData: null,
});
