...
const actions = {
    async fetchPageData({commit}, params) {
        const res = await baseHttp.get('user-groups/fetch', {
            params
        });
    ...
    async fetchByField({commit}, params) {
        const res = await baseHttp.get('user-groups/fetch-by-field', {
            params
        });
    ...
    async delete({state}) {
        return await baseHttp.delete(`user-groups/delete/${state.deletingItemId}`);
    },

    async create({}, params) {
        return await baseHttp.post(`user-groups/insert`, params);
    },

    async update({}, params) {
        return await baseHttp.put(`user-groups/update`, params);
    },
};
