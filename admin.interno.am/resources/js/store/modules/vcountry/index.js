...
const actions = {
    async fetchPageData({commit}, params) {
        const res = await baseHttp.get('vcountries/fetch', {
            params
        });
    ...
    async fetchByField({commit}, params) {
        const res = await baseHttp.get('vcountries/fetch-by-field', {
            params
        });
    ...
    async delete({state}) {
        return await baseHttp.delete(`vcountries/delete/${state.deletingItemId}`);
    },

    async create({}, params) {
        return await baseHttp.post(`vcountries/store`, params);
    },

    async update({}, params) {
        return await baseHttp.put(`vcountries/update`, params);
    },
};
