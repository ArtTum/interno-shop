                    ...
                    <tr>
                        <td align="center" style="padding:0;Margin:0">
                            <table bgcolor="#ffffff" class="es-header-body" align="center" cellpadding="0"
                                ...
                                <tr>
                                    <td align="left" style="padding:20px;padding-bottom:0;Margin:0">
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="center" class="es-m-txt-c"
                                                                    ...
                                                                    <h1 style="Margin:0;line-height:32px;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-size:32px;font-style:normal;font-weight:bold;color:#333333">
                                                                        {{ $title }}
                                                                    </h1>
                                                                </td>
                                                            </tr>
                    ...
                    <tr>
                        <td align="center" style="padding:0;Margin:0">
                            <table bgcolor="#ffffff" class="es-content-body" align="center" cellpadding="0"
                                   ...
                                   style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#FFFFFF;width:640px">
                                <tr>
                                    <td align="left" style="padding:20px; padding-bottom: 0 !important;Margin:0">
                                        <table cellpadding="0" cellspacing="0" width="100%"
                                               style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                            <tr>
                                                <td align="center" valign="top" style="padding:0;Margin:0;width:560px">
                                                    <table cellpadding="0" cellspacing="0" width="100%"
                                                           style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                        <tr>
                                                            <td class="es-m-p0r es-m-p0l"
                                                                style="Margin:0;padding-top:5px;padding-bottom:0px;padding-left:40px;padding-right:40px;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">
                                                                {!! $topText !!}
                                                                @if(isset($buttonName) && isset($buttonPath))
                                                                ...
                                                                @if(isset($verificationToken))
                                                                    <a class="button-style"
                                                                       href="{{ $baseUrl }}/verify-review/{{ $verificationToken }}/{{ $vendorKey ?? '' }}">
                                                                        {{ $translation['email_review_verification'] ?? '{email_review_verification}' }}
                                                                    </a>
                                                                @endif
                                                            </td>
                                                        </tr>
                                ...
                                @if($productTable || isset($zipLink) || !empty($formContent) || (isset($addressTable) && $addressTable) || $bottomText)
                                    <tr>
                                        <td align="left"
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            @if(isset($zipLink))
                                                                <tr>
                                                                    ...
                                                                    <span lang=EN-US>
                                                                        {{ $translation['email_attached_files'] ?? '{email_attached_files}' }}: {{ $zipLink }}
                                                                    </span>
                                                                        </p>
                                                                    </td>
                                                                </tr>
                                                            ...
                                                            @if(!empty($formContent))
                                                                ...
                                                                @endforeach
                                                            @endif
                                                            @if(isset($addressTable) && $addressTable)
                                                                <tr>
                                                                    <td class="es-m-txt-r"
                                ...
                                <tr>
                                    <td align="left"
                                        style="Margin:0;padding-bottom:10px;padding-top:15px;padding-left:20px;padding-right:20px"></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                                                                        ...
                                                                        @foreach($socials as $social)
                                                                            <td align="center" valign="top"
                                                                                ...
                                                                                <a href="{{ $social->url }}">
                                                                                    <img
                                                                                        title="{{ $social->icon }}"
                                                                                        src="{{ $baseUrl }}/icon/{{ $social->icon }}-logo-black.png"
                                                                                        alt="Yt" width="32"
