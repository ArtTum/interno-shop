...
//                Route::get('fetch-vendors-for-switch', [GeneralController::class, 'fetchVendorsForSwitch']);
            ...
            Route::group(['prefix' => 'shop-frontend'], function () {
                ...
                Route::get('orders', [ShopFrontendController::class, 'orders'])->middleware('check.permission:shop_orders,can_view');
                Route::get('orders/{id}/invoice', [ShopFrontendController::class, 'orderInvoice'])->middleware('check.permission:shop_orders,can_view');
                Route::patch('orders/{id}/status', [ShopFrontendController::class, 'updateOrderStatus'])->middleware('check.permission:shop_orders,can_edit');
            });
