...
const translations = {
  hy: {
    ...
    selectCraftsmanQuestion: 'Ցանկանո՞ւմ եք ընտրել արհեստավոր',
    yes: 'Այո',
    no: 'Ոչ',
    home: 'Գլխավոր',
    lastName: 'Ազգանուն',
  ...
  en: {
    ...
    selectCraftsmanQuestion: 'Would you like to choose a craftsman?',
    yes: 'Yes',
    no: 'No',
    home: 'Home',
    lastName: 'Last name',
  ...
  ru: {
    ...
    selectCraftsmanQuestion: 'Хотите выбрать мастера?',
    yes: 'Да',
    no: 'Нет',
    home: 'Главная',
    lastName: 'Фамилия',
